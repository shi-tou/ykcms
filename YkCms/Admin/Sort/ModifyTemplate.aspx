...
<body>
    ...
    <div class="easyui-tabs" data-options="border:false">
        <input id="templatelist-templateid" name="templatelist-templateid" type="hidden" value="<%=tinfo.TemplateID %>" />
        <div title="基本信息" style="padding: 10px">
            <dl>
                <dt>模板名称:</dt>
                <dd><input class="easyui-validatebox" type="text" id="templatelist-templatename" name="templatelist-templatename" data-options="required:true" missingmessage="请输入模板名称！" validtype="checkTemplateName" value="<%=tinfo.TemplateName %>" /></dd>
                <dt>模板地址:</dt>
                <dd><input class="easyui-validatebox" type="text" id="templatelist-templateurl" name="templatelist-templateurl" value="<%=tinfo.TemplateUrl %>" /></dd>
                <dt>模板描述:</dt>
                <dd><textarea class="textarea" id="templatelist-templatedesc" name="templatelist-templatedesc"><%=tinfo.TemplateDesc %></textarea></dd>
            </dl>
        </div>
        <div title="模板内容" style="padding: 10px">
            <CKEditor:CKEditorControl ID="templatesource" Name="templatesource" BasePath="/ckeditor" runat="server" style="width:"><%=tinfo.TemplateSource%></CKEditor:CKEditorControl>
        </div>
    </div>
    <div class="blank"></div>
