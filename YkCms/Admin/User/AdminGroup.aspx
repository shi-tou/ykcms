...
<div class="main">
    ...
    <!--end 列表-->
    <!--start 表单窗口-->
    <div id="groupWin" class="easyui-window" title="添加权限组" data-options="iconCls:'icon-save',modal:true,closed:true,minimizable:false,maximizable:false,collapsible:false" >
        <form id="groupForm">
        ...
        <dl>
            ...
            <dt>权限组描述:</dt>
            <dd><textarea class="textarea" id="admingroup-describe" name="admingroup-describe" /></dd>
            <dt>权限组分配:</dt>
            <dd>
